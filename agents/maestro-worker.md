---
name: maestro-worker
description: Maestro standard-tier worker for typical implementation subtasks — features, bugfixes, tests, straightforward integrations. Dispatched by the maestro skill with a full mergeability contract.
model: sonnet
effort: medium
maxTurns: 40
